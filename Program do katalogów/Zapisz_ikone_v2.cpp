...
bool SaveIcon(HICON hIcon, INT nColorBits, const TCHAR* szPath)
{
	...
	{
		MessageBox(NULL, TEXT("Test1"), TEXT("B³¹d"), 0);
		return false;
	}
	...
	{
		MessageBox(NULL, TEXT("Test2"), TEXT("B³¹d"), 0);
		return false;
	}
	...
	{
		MessageBox(NULL, TEXT("Test3"), TEXT("B³¹d"), 0);
		return false;
	}
	...
	{
		MessageBox(NULL, TEXT("Test4"), TEXT("B³¹d"), 0);
		return false;
	}
	...
	{
		MessageBox(NULL, TEXT("Test5"), TEXT("B³¹d"), 0);
		return false;
	}
	...
	{
		MessageBox(NULL, TEXT("Test6"), TEXT("B³¹d"), 0);
		return false;
	}
	...
	file.Close();
	MessageBox(NULL, TEXT("Misja zakoñczona"), TEXT("Sukces"), 0);
	return true;
}
